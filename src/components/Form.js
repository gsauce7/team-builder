...
const Form = (props) => {
 ...
 const [team,setTeam] = useState({name: "", email : "", role: "", favFood: ""})
...
const changes = (event) => {
  ...
  //  console.log(team);
        ...
        const addMember = event => {
            ...
            setTeam({name: "" , email : "" , role: "", favFood: ""});
        }
    ...
    return (
      <form onSubmit= {addMember}>
       ...
       <label htmlFor = "role">Role</label>
        ...
        <input type = "text" placeholder = "Favorite Food" name = "favFood" id = "favFood" value = {team.favFood}  onChange={changes} />
